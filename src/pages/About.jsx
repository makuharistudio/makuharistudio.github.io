        ...
        <content className='content-no-bg'>
            ...
            <div id='about'>
                ...
                <div id='about-desc'>
                    ...
                    <p>A data and tech enthusiast with over 12 years client services experience in the advertising software and healthcare industries.</p>
                    <p>Specialist in software problem-solving and performing data analysis with SQL querying, Excel data models, and Power BI.</p>
                    <ul>
