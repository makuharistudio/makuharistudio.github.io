...
![Power BI Tokyo example](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--01.png?raw=true)
...
This post incorporates my previous posts on [how to import time zone and daylight saving observations from Wikipedia](https://makuharistudio.github.io/#/post/1633183200), which indicate when different offsets are applied (e.g. first Sunday of October), and my post on [how to find the nth day of a month](https://makuharistudio.github.io/#/post/1632578400) to convert those into usable "anchors" to determine the offset value for the date/times.
...
This is the **[sample date/time dataset](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/Date_times_to_convert.xlsx?raw=true)** we will dynamically apply time zone offsets to via parameter selection.
...
![Sample date time dataset in Excel](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--02.png?raw=true)

![Sample date time dataset imported into Power Query](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--03.png?raw=true)

After importing the sample date/time dataset, we next import the combined time zone offset and daylight savings observation **[dataset](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/Time_zone_offsets_and_DST_observations.xlsx?raw=true)** created in this [post](https://makuharistudio.github.io/#/post/1633183200).

At this point, if you only need certain time zones to select from, you can filter for them here before proceeding.

![Offset and observation dataset imported into Power Query](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--04.png?raw=true)

Next, we will create a list from the Timezone column, to be used as the available selections of the parameter.

![Power Query Convert to List Part A](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--05.png?raw=true)

![Power Query Convert to List Part B](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--06.png?raw=true)

Then set up the parameter itself to pull from that list.

![Power Query Create new parameter](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--07.png?raw=true)

![Power Query Manage Parameters Part A](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--08.png?raw=true)

![Power Query Manage Parameters Part B](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--09.png?raw=true)

Next, we create a new column in the sample dataset whose value is the parameter selection.

![Power Query custom column for Parameter value Part A](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--10.png?raw=true)

![Power Query custom column for Parameter value Part B](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--11.png?raw=true)

Then merge the two datasets using that new custom column.
![Power Query Merge Queries](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--12.png?raw=true)

![Power Query Merge Queries](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--13.png?raw=true)
...
![Power Query expand merge queries Part A](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--14.png?raw=true)

![Power Query expand merge queries Part B](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--15.png?raw=true)
...
![Power Query create custom function Part A](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--16.png?raw=true)

![Power Query create custom function Part B](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--17.png?raw=true)
...
![Power Query create 1st custom function](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--18.png?raw=true)
...
* The second and third else if conditions convert to date time zones based on 1st, 2nd, 3rd, or 4th occurrence of specified day anchors, and are based on this previous [post](https://makuharistudio.github.io/#/post/1632578400).
* The fourth and fifth if else conditions convert based on the last occurrence of the specified day anchor, based on the last section of that same [post](https://makuharistudio.github.io/#/post/1632578400).
...
![Power Query create 2nd custom function](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--19.png?raw=true)
...
![Power Query create 3rd custom function](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--20.png?raw=true)
...
![Power BI Create report](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--21.png?raw=true)
...
![Power BI Sydney example Part A](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--22a.png?raw=true)

![Power BI Sydney example Part B](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--22.png?raw=true)

Europe, Dublin is a time zone that uses UTC time and "last position" (indicated by the 9), for its anchors.
![Power BI Dublin example Part A](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--23a.png?raw=true)

![Power BI Dublin example Part B](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--23.png?raw=true)

Africa, Casablanca is a time zone that uses a fixed date of the month for its anchors.
![Power BI Casablanca example Part A](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--24a.png?raw=true)

![Power BI Casablanca example Part B](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-10--24.png?raw=true)
...
Click **[here](https://github.com/makuharistudio/makuharistudio.github.io/blob/main/src/posts/2021-10-10.md)** for this post's markdown file in GitHub.