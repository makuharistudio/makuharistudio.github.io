...
![Wikipedia List of tz database time zones](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--01.png?raw=true)
...
![Wikipedia Daylight saving time by country](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--02.png?raw=true)

**Exercise 1:**

Beginning with the time zone offset hours, we Get Data from Web and provide the URL.

![Power BI Import data from a web page](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--03.png?raw=true)
...
![Power BI Import data Basic setting and set URL](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--04.png?raw=true)

The HTML table we are after is the list containing the offsets.
Tick it, then click Transform Data.

![Power BI Import data web page table selection](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--05.png?raw=true)

Next we Use First Row as Headers to assign the column names.

![Power Query Use First Row as Headers](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--06.png?raw=true)
...
![Power Query Replace text to make more readable](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--07.png?raw=true)
...
```
![Power Query Custom Column: Standard UTC offset](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--08.png?raw=true)
...
```
![Power Query Custom Column: Daylight Saving UTC offset](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--09.png?raw=true)
...
![Power Query Custom Column: Offset difference](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--10.png?raw=true)

Next we filter out the data rows not required, starting with only including Canonical status offsets

![Power Query Filter for Canonical records](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--11.png?raw=true)

Then we filter for time zones that have a country code.

![Power Query Filter for country codes](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--12.png?raw=true)

Lastly, remove columns that won’t be needed, depending on what you need for your data source.

![Power Query Remove other columns](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--13.png?raw=true)
...
![Power BI Export table results](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--14.png?raw=true)
...
![Power BI Import data Basic setting and set URL](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--15.png?raw=true)

Again, click Transform Data and Use First Row as Headers.

![Power BI Import data web page table selection](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--16.png?raw=true)

![Power Query Use First Row as Headers](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--17.png?raw=true)

Next we filter for records with a valid current DST start value.

![Power Query Filter for valid DST start](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--18.png?raw=true)
...
![Power Query Exploring qualitative data values](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--19.png?raw=true)
...
![Power Query Custom Column: DST start position anchor](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--20.png?raw=true)
...
![Power Query Custom Column: DST start day anchor](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--21.png?raw=true)
...
![Power Query Custom Column: DST start month anchor](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--22.png?raw=true)
...
![Power Query Custom Column: DST start UTC time anchor](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--23.png?raw=true)
...
![Power Query Custom Columns for DST end](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--24.png?raw=true)

Then we can retain the columns we need, such as Country/Territory, Notes, and the custom columns we created.

![Power Query Remove other columns](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--25.png?raw=true)
...
![Power BI Export table results](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--26.png?raw=true)
...
![Power Query Merge Queries](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--27.png?raw=true)
...
![Power Query Merge using fuzzy matching](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--28.png?raw=true)
...
Find a copy of the end product to download as an Excel file **[here](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/Time_zone_offsets_and_DST_observations.xlsx?raw=true)**.
...
![Manually cleaned output](https://raw.githubusercontent.com/makuharistudio/makuharistudio.github.io/main/src/assets-blog/2021-10-03--29.png?raw=true)

Click **[here](https://github.com/makuharistudio/makuharistudio.github.io/blob/main/src/posts/2021-10-03.md)** for this post's markdown file in GitHub.